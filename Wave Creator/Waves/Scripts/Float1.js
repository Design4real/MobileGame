...
function SetHeight () {
	...
	transform.position.y = (selectectWaves.FindHeight(transform.position.x, transform.position.z))/myfactor + offset + selectectWaves.transform.position.y; // Sets your objects y axis by going into the FindHeight function in the WaveScript which deals with the maths, we then add the offset and the waveObject y position.
}
