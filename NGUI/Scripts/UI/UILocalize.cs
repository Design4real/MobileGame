...
public class UILocalize : MonoBehaviour
{
	...
	public void Localize ()
	{
		...
		{
			lbl.text = val;
			if (Localization.instance.currentLanguage == "En")
			{
				lbl.font = MenuController.runtime.font[0];
			}
			if (Localization.instance.currentLanguage == "Ru")
			{
				lbl.font = MenuController.runtime.font[1];
			//	lbl.transform.localPosition = new Vector3 (lbl.transform.localPosition.x,
			//											lbl.transform.localPosition.y,
			//											-40);
			} 
		}
		else if (sp != null)
